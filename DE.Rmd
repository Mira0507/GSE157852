...
title: "Comparative analysis of Alignment/Mapping Pipelines"
author: "Mira Sohn" 
---
...
rankdiff.plot.fn(fdr.rankdiff, "FDR") + ylim(-2500, 2500) 
rankdiff.plot.fn(lfc.rankdiff, "Log2FoldChange") + ylim(-2500, 2500)
rankdiff.plot.fn(up.lfc.rankdiff, "Log2FoldChange (Increase)") + ylim(-2500, 2500)
rankdiff.plot.fn(down.lfc.rankdiff, "Log2FoldChange (Decrease)") + ylim(-2500, 2500)
           
# Display the plots in free y-scale
rankdiff.plot.fn(lfc.rankdiff, "Log2FoldChange (Large Mag)") + ylim(-1500, 1500)
rankdiff.plot.fn(up.lfc.rankdiff, "Log2FoldChange (Increase, Large Mag)") + ylim(-750, 750)
rankdiff.plot.fn(down.lfc.rankdiff, "Log2FoldChange (Decrease, Large Magn)") + ylim(-600, 600)
