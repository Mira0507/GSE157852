...
title: "Gene Ranking Analysis in SARS-CoV-2-infected Human Neuron Cells"
author: "Mira Sohn" 
---
...
### - DE analysis: [Link](https://github.com/Mira0507/GSE157852/blob/master/DE.Rmd)
...
# Import data
rankdiff <- fread("h_LFC_RankDiff.csv")[, -1]
...
Ranking.Category <- "Log2FoldChange"
...
geom_jitter(width=0.25, alpha=0.7) + 
    ...
    ggtitle(paste("Characteristics of Differently Ranked Genes in", 
                  Ranking.Category)) +
...
geom_jitter(width=0.25, alpha=0.7) + 
    ...
    geom_text(data=cl.rankdiff, 
              mapping=aes(x=Inf, y=Inf, label=P.Val), vjust=2, hjust=1.1, color="black", size=4) 
